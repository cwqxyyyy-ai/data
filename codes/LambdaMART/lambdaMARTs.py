...
class lambdaMART:
    ...
    def validate(self, data):
        ...
        return [predicted_scores, {'average_ndcg':average_ndcg,'rightRate_succedSort':rightRate_succedSort,
                                   'rightRate_top1':rightRate_top1, 'average_rightRate':average_rightRate}]
